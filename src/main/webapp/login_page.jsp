...
<head>
    ...
    <style>
        body {
            ...
            background-color: #a1e3d8; /* Pool color background */
            margin: 0;
            padding: 0;
            display: flex;
        ...
        .title {
            text-align: center;
            color: #ff4d6d; /* Brighter peony color for better visibility */
            margin-bottom: 8px;
            font-size: 24px; /* Increased font size */
            font-weight: bold; /* Bold text for emphasis */
            text-shadow: 1px 1px 3px rgba(0, 0, 0, 0.2); /* Subtle shadow for contrast */
        }
