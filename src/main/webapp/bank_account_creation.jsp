...
<head>
    ...
    <style>
        ...
        a {
            ...
            background-color: rgba(255, 255, 255, 0.7); /* Light background for the link */
            border-radius: 4px; /* Rounded corners for the link background */
...
<body>
    <form action="bankregis" method="post">
        ...
        <div class="form-section">
            ...
            <input type="text" id="initialDeposit" name="amount" min="0" max="1000" required>
        </div>
